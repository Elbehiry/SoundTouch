...
Java_com_elbehiry_soundtouch_SoundTouch_getVersionString(JNIEnv *env, jobject thiz) {
    const char *verStr;
...
Java_com_elbehiry_soundtouch_SoundTouch_newInstance(JNIEnv *env, jobject thiz) {
...
Java_com_elbehiry_soundtouch_SoundTouch_deleteInstance(JNIEnv *env, jobject thiz,jlong handle) {
    SoundTouch *pSoundTouch = (SoundTouch*)handle;
    delete pSoundTouch;
}

extern "C" DLL_PUBLIC void
Java_com_elbehiry_soundtouch_SoundTouch_init(JNIEnv *env, jobject thiz,jlong handle, jint channels,
...
extern "C" DLL_PUBLIC void
Java_com_elbehiry_soundtouch_SoundTouch_setTempo(JNIEnv *env, jobject thiz,
...
extern "C" DLL_PUBLIC void
Java_com_elbehiry_soundtouch_SoundTouch_setPitchSemiTones(JNIEnv *env, jobject thiz,
...
extern "C" DLL_PUBLIC void
Java_com_elbehiry_soundtouch_SoundTouch_setRate(JNIEnv *env, jobject thiz,
...
extern "C" DLL_PUBLIC void
Java_com_elbehiry_soundtouch_SoundTouch_setRateChange(JNIEnv *env, jobject thiz,
...
extern "C" DLL_PUBLIC void
Java_com_elbehiry_soundtouch_SoundTouch_setTempoChange(JNIEnv *env, jobject thiz,
...
extern "C" DLL_PUBLIC jstring
Java_com_elbehiry_soundtouch_SoundTouch_getErrorString(JNIEnv *env, jobject thiz) {
...
extern "C" DLL_PUBLIC void
Java_com_elbehiry_soundtouch_SoundTouch_putSamples(JNIEnv *env, jobject thiz,
...
Java_com_elbehiry_soundtouch_SoundTouch_receiveSamples(JNIEnv *env, jobject thiz,
...
extern "C" DLL_PUBLIC jint
Java_com_elbehiry_soundtouch_SoundTouch_flush(JNIEnv *env, jobject thiz,
...
Java_com_elbehiry_soundtouch_SoundTouch_processFile(JNIEnv *env, jobject thiz,
